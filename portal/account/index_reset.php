...
if (!(isset($GLOBALS['portal_onsite_two_enable'])) || !($GLOBALS['portal_onsite_two_enable'])) {
    echo xlt('Portal de Pacientes off');
    exit;
}
if (!empty($_POST)) {
...
if (isset($_POST['submit'])) {
    if (!$valid) {
        $errmsg = xlt("Credenciales inválidas.") . xlt("Desconocido.");
...
<html>
<head>
    <title><?php echo xlt('Cambiar las credenciales'); ?></title>
    <?php
    ...
    <div class="container">
        <form action="" method="POST" onsubmit="return process_new_pass()">
            ...
            <table class="table table-sm" style="border-bottom:0px;width:100%">
                <tr>
                    <td width="35%"><strong><?php echo xlt('Nombre de la cuenta'); ?><strong></td>
                    <td><input class="form-control" name="uname" id="uname" type="text" readonly
                            value="<?php echo attr($auth['portal_username']); ?>" /></td>
                </tr>
                <tr>
                    <td><strong><?php echo xlt('Nuevo o nombre actual'); ?><strong></td>
                ...
                <tr>
                <tr>
                    <td><strong><?php echo xlt('Confirme usuario'); ?><strong></td>
                ...
                <tr>
                    <td><strong><?php echo xlt('Nueva o contraseña actual'); ?><strong></td>
                    <td>
                ...
                <tr>
                    <td><strong><?php echo xlt('Confirmar Contraseña'); ?><strong></td>
                    <td>
            ...
            <div><strong><?php echo '* ' . xlt("Todas las contraseñas distiguen mayúscular y minúsculas!") ?></strong></div>
        </form>
    </div><!-- container -->
</body>
</html>
