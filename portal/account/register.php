...
<html>
<head>
    <title><?php echo xlt('Nuevo Paciente'); ?> | <?php echo xlt('Registro'); ?></title>
...
<body class="mt-4 skin-blue">
    <div class="container-lg">
        <h1 class="text-center"><?php echo xlt('Registro de Cuenta'); ?></h1>
        <div class="stepwiz">
            <div class="stepwiz-row setup-panel">
                <div class="stepwiz-step">
                    <a href="#step-1" type="button" class="btn btn-primary btn-circle">1</a>
                    <p><?php echo xlt('Verificar Email') ?></p>
                </div>
                <div class="stepwiz-step">
        ...
        <form id="startForm" role="form">
            <div class="text-center setup-content" id="step-1">
                <div class="jumbotron">
                    ...
                    <div class="alert alert-success" role="alert"><?php echo xlt("Su email ha sido verificado. Click Siguiente."); ?></div>
                </div>
                <button class="btn btn-primary nextBtn pull-right" type="button"><?php echo xlt('Siguiente') ?></button>
            </div>
        </form>
        <!-- Profile Form -->
        <form id="profileForm" role="form" action="account/account.php" method="post">
            <div class="text-center setup-content" id="step-2" style="display: none">
                <legend class="bg-primary text-white"><?php echo xlt('Perfil') ?></legend>
                <div class="jumbotron">
                    <iframe class="embedded-content" src="patient/patientdata?pid=0&register=true" id="profileFrame" name="Profile Info"></iframe>
                </div>
                <button class="btn btn-primary pull-right" type="button" id="profileNext"><?php echo xlt('Siguiente') ?></button>
            </div>
        </form>
        <!-- Insurance Form -->
        <form id="insuranceForm" role="form" action="" method="post">
            <div class="text-center setup-content" id="step-3" style="display: none">
                <legend class='bg-primary text-white'><?php echo xlt('Seguro') ?></legend>
                <div class="jumbotron">
                    <div class="form-row">
                        <div class="col-12 col-md-6 col-lg-3 form-group">
                            <label for="provider"><?php echo xlt('Compañia de Seguro') ?></label>
                        ...
                        <div class="col-12 col-md-6 col-lg-3 form-group">
                            <label for="plan_name"><?php echo xlt('Nombre del Plan') ?></label>
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" name="plan_name" required placeholder="<?php echo xla('required'); ?>">
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-3 form-group">
                            <label for="policy_number"><?php echo xlt('Número de Póliza') ?></label>
                            <div class="controls inline-inputs">
                ...
                <button class="btn btn-primary prevBtn btn-sm pull-left" type="button"><?php echo xlt('Anterior') ?></button>
                <button class="btn btn-primary nextBtn btn-sm pull-right" type="button"><?php echo xlt('Siguiente') ?></button>
            </div>
        </form>
        ...
        <div class="text-center setup-content" id="step-4" style="display: none">
            <legend class='bg-success text-white'><?php echo xlt('Registro') ?></legend>
            <div class="jumbotron">
                <h4 class='bg-success'><?php echo xlt("Todo listo. Click enviar solicitud a continuación para finalizar registración.") ?></h4>
                <hr />
                <p>
                    <?php echo xlt("Un e-mail con nuevas credenciales de cuenta se ha enviado. Ustede puede revisar y editar su información. Si encuentra algún problema durante el proceso de registro, por favor enviar un mail a hola@epa-bienestar.com.") ?>
                </p>
            </div>
            <hr />
            <button class="btn btn-primary prevBtn float-left" type="button"><?php echo xlt('Anterior') ?></button>
            <button class="btn btn-success float-right" type="button" id="submitPatient"><?php echo xlt('Enviar solicitud') ?></button>
        </div>
    </div>
</body>
</html>
